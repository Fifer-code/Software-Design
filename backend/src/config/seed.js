...
const seedDatabase = async () => {
    ...
    // seed 10 waiting users per service
    ...
    if (historyCount === 0) {
        for (const serviceData of defaultServices) {
            ...
            await History.create({
                ...
                serviceId: serviceData.serviceId,
                event: 'joined',
                message: `User 15 joined the ${serviceData.name} queue`,
            ...
            await History.create({
                ...
                serviceId: serviceData.serviceId,
                event: 'removed',
                message: `User 15 was removed from the ${serviceData.name} queue`,
                timestamp: removedAt
            });
        }
